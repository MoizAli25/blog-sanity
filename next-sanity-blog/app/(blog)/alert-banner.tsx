    ...
    <nav className="bg-black shadow-md">
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white shadow-md">
          ...
          {/* Buttons for Sign In and Registry */}
          <button className="block w-full text-left py-2 px-4 text-gray-700 hover:bg-gray-100 hover:text-blue-500">
            Sign In
          </button>
          <button className="block w-full text-left py-2 px-4 text-white bg-teal-400 hover:bg-teal-300 rounded-lg">
            Registry
          </button>
        </div>
      )}
